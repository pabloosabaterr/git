...
`--dry-run`::
	Do not download any objects, print the number of blobs to be
	fetched and if the server has the object-info capability enabled
	prints also the total size of those blobs.
